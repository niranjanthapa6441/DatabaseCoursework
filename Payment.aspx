     ...
     <!--End Top Nav -->
        <div>
            ...
            <asp:DropDownList CSSClass="form-control" ID="DropDownList1" runat="server" AutoPostBack="true" DataSourceID="SqlDataSource3" DataTextField="NAME" DataValueField="COLLEGE_ID">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Coursework %>" ProviderName="<%$ ConnectionStrings:Coursework.ProviderName %>" SelectCommand="SELECT S.ID AS COLLEGE_ID,P.FIRST_NAME ||' '|| P.MIDDLE_NAME ||' ' ||P.LAST_NAME  AS NAME,P.PHONE_NUMBER,P.EMAIL FROM STUDENT S
